    ...
    useEffect(() => {
     ...
     return (
        (<React.Fragment>
            ...
            {randomPost ?
                (
                    <Card className={classes.randomPost}><Link underline='none' component={RouterLink} to={randomPost.url}>
                        <CardActionArea>
                        <Chip className={classes.chipCustom} label={randomPost.tag_list ? randomPost.tag_list[0] : ''} /> 
                            <CardMedia
                            ...
                            <CardContent>
                                ...
                                <Typography className={classes.randomPost.content} variant="body2" component="p">
